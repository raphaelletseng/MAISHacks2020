      ...
      <CenterContent>
        <SocialLinks>
          <a
            ...
            className={cx(iconStyle, 'icon-mail-alt')}
          />
          <a
            aria-label="Facebook"
            ...
            target="_blank"
            rel="noopener"
            className={cx(iconStyle, 'icon-facebook')}
          />
          <a
            aria-label="Twitter"
            ...
            target="_blank"
            rel="noopener"
            className={cx(iconStyle, 'icon-twitter')}
          />
          <a
            ...
            target="_blank"
            rel="noopener"
            className={cx(iconStyle, 'icon-instagram')}
          />
          <a
            aria-label="Medium"
            ...
            target="_blank"
            rel="noopener"
            className={cx(iconStyle, 'icon-medium')}
          />
          <a
            aria-label="Github"
            ...
            target="_blank"
            rel="noopener"
            className={cx(iconStyle, 'icon-github')}
          />
          <a
            aria-label="Linkedin"
            ...
            target="_blank"
            rel="noopener"
            className={cx(iconStyle, 'icon-linkedin')}
          />
        </SocialLinks>
        ImplementAI {year}
      </CenterContent>
